...
const CommunityCard = ({ item }: CommunityCardProps) => {
  ...
  return (
    <div className='h-[260px] w-[299px] flex flex-col items-center mt-8'>
      ...
      <h1 className='font-bold text-muted text-center text-lg md:text-xl lg:text-2xl xl:text-3xl mt-4 mb-2'>
        {title}
      </h1>
      <p className='font-normal text-muted-foreground text-center text-sm md:text-base lg:text-lg'>
        {description}
      </p>
    </div>
  );
